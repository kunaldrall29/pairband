...
Merge templates/AGENTS.md with the actual repository instructions. Use the selected stage as the task boundary and keep edits reviewable in the existing workspace. Preserve user changes, complete local work autonomously and report real verification evidence. Do not create a second architecture merely because another tool wrote earlier stages.
